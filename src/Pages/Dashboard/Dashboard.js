  ...
  return (
    <div className="font-poppins antialiased">
      <div
        ...
        x-data="{ sidenav: true }"
      >
        <button className="p-2 border-2 bg-white rounded-md border-gray-200 shadow-lg text-gray-500 focus:bg-teal-500 focus:outline-none focus:text-white absolute top-0 right-0 sm:hidden">
          <svg
