      ...
      <div className="mx-auto container">
        ...
        <div className={`nav-1 lg:justify-between sm:hidden lg:flex ${show && 'nav-hidden'}`}>
          <div className='nav-icon-1 '>
            <div className='flex'>
              <AiOutlineInstagram className='text-white pr-3 w-7 h-7 font-bold'></AiOutlineInstagram>
              <GrTwitter className='text-white pr-3 w-7 h-7 font-bold '></GrTwitter>
              <AiOutlineLinkedin className='text-white pr-3 w-7 h-7 font-bold ' ></AiOutlineLinkedin>
              <AiOutlineYoutube className='text-white pr-3 w-7 h-7 font-bold ' ></AiOutlineYoutube>
            </div>
          </div>
          <div className='nav-manu-1'>
            <div className=' flex'>
              <h2 className='text-white pl-3 text-[13px]'>ONLINE BANKING</h2>
              <h2 className='text-white pl-3 text-[13px] ' >FORMS</h2>
              <h2 className='text-white pl-3 text-[13px] '>CONTACT</h2>
            </div>
          </div>
        </div>
        {/* nav two  */}
